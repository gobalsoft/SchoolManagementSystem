...
academics:SchoolAcademic[]=[];
  constructor(private formBuilder: FormBuilder,private router: Router, private route: ActivatedRoute,private schoolService:SchoolService) { }
  ...
  this.schoolService.editAcademic(this.editdata).subscribe((data: SchoolAcademic[])=>{
    console.log(data);
    this.academics = data;
